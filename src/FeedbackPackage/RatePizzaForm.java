...
public class RatePizzaForm extends javax.swing.JFrame {

    public RatePizzaForm() {
        initComponents();
        setTitle("Rate Pizza Form"); // window title
    ...
    public void getPizzas() {
        ...
        for (Pizza item : PizzaDashboard.pizzaList) {
            // add pizza ids to cmbPizza
            cmbPizza.addItem(item.getID());
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // ** submit rating
        // vars
        String pizzaID = cmbPizza.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RatePizzaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
